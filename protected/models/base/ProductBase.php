 ...
 */
class ProductBase extends CActiveRecord implements IECartPosition {
    ...
    public function rules() {
        ...
        return array(
            ...
            array('id, name, alias, uri, image, sku, quantity, price, wholesale_price, bought, discount, sale_promotion, like, subscripbe, description, detail, status, create_time, update_time', 'safe', 'on' => 'search'),
        );
    }
