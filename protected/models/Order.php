...
class Order extends OrderBase
{
	...
	public function rules()
	{
		...
		return array(
			array('customer_id, create_time, invoice_total, shipping_fee, grand_total', 'required'),
			...
			array('order_id, customer_id, create_time, status, invoice_total, shipping_fee, grand_total, is_paid, command', 'safe', 'on'=>'search'),
		);
	}
