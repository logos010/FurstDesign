<?php
$this->pageTitle = 'View Translates #' . $model->id; 
$this->breadcrumbs=array(
	'Translates'=>array('index'),
	$model->id,
);
?>
<div style="display: none" class="alert alert-success alert-dismissable" id="Translate_<?php echo $model->id ?>">
    ...
    $(document).ready(function() {
        $('#delete').bind('click', function() {
            ...
            $.ajax({
                ...
                $('div.panel').toggle();
                $('#Translate_').html(data.msg).toggle();
            });
            return false;
        });
    });
