...
return array(
	...
	'username or email' => 'Tên đăng nhập hoặc E-Mail',
	'password' => 'Mật khẩu',
	'Remember me next time' => 'Ghi nhớ',
	'Username is incorrect.' => 'Tên đăng nhập không chính xác',
	'Email is incorrect.' => 'E-Mail không chính xác.',
	...
	'No' => 'Không',
	'Yes' => 'Có',
	'Yes and show on registration form' => 'Yes và hiện trên form đăng ký',
	'No, but show on registration form' => 'No không hiện trên form đăng ky',
	'Not active' => 'Chưa kích hoạt',
	'Active' => 'Kích hoạt',
	'Banned' => 'Cấm',
	'Please fill out the following form with your login credentials:' => 'Vui lòng nhập đầy đủ thông tin đăng nhập:',
	'Fields with <span class="required">*</span> are required.' => 'Field với <span class="required"> * </ span> là bắt buộc.',
	'List User' => 'Danh sách thành viên',
	'Edit' => 'Chỉnh sửa',
	'Edit profile' => 'Chỉnh sửa thông tin',
	'Create User' => 'Tạo thành viên',
	'Create' => 'Create',
	'Manage' => 'Quản lý',
	'Manage User' => 'Quản lý thành viên',
	'Users' => 'Thành viên',
	'Update User' => 'Cập nhập thành viên',
	...
	'Changes is saved.' => 'Thông tin đã được cập nhật.',
